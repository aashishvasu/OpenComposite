...
class CVROverlay_016 : IVROverlay_016::IVROverlay, public CVRCommon {
	CVR_GEN_IFACE();
...
public:
	...
	*	by default this is the pid of the process that made the overlay */
	...
	INTERFACE_FUNC(EVROverlayError, SetOverlayFlag, VROverlayHandle_t ulOverlayHandle, IVROverlay_016::VROverlayFlags eOverlayFlag, bool bEnabled);

	/** Sets flag setting for a given overlay */
	INTERFACE_FUNC(EVROverlayError, GetOverlayFlag, VROverlayHandle_t ulOverlayHandle, IVROverlay_016::VROverlayFlags eOverlayFlag, bool *pbEnabled);
	...
	* If the texture needs to be resolved, you should call SetOverlayTexture with the appropriate colorspace instead. */
	...
	INTERFACE_FUNC(EVROverlayError, GetOverlayTransformType, VROverlayHandle_t ulOverlayHandle, IVROverlay_016::VROverlayTransformType *peTransformType);
	...
	* If there are no events this method returns false. uncbVREvent should be the size in bytes of the VREvent_t struct */
	...
	INTERFACE_FUNC(EVROverlayError, GetOverlayInputMethod, VROverlayHandle_t ulOverlayHandle, IVROverlay_016::VROverlayInputMethod *peInputMethod);

	/** Sets the input settings for the specified overlay. */
	INTERFACE_FUNC(EVROverlayError, SetOverlayInputMethod, VROverlayHandle_t ulOverlayHandle, IVROverlay_016::VROverlayInputMethod eInputMethod);
	...
	* specified settings. Returns false if there is no intersection. */
	INTERFACE_FUNC(bool, ComputeOverlayIntersection, VROverlayHandle_t ulOverlayHandle, const IVROverlay_016::VROverlayIntersectionParams_t *pParams, IVROverlay_016::VROverlayIntersectionResults_t *pResults);
	...
	* ends will be cleared */
	INTERFACE_FUNC(EVROverlayError, SetOverlayNeighbor, IVROverlay_016::EOverlayDirection eDirection, VROverlayHandle_t ulFrom, VROverlayHandle_t ulTo);

	/** Changes the Gamepad focus from one overlay to one of its neighbors. Returns VROverlayError_NoNeighbor if there is no
	* neighbor in that direction */
	INTERFACE_FUNC(EVROverlayError, MoveGamepadFocusToNeighbor, IVROverlay_016::EOverlayDirection eDirection, VROverlayHandle_t ulFrom);
	...
	*/
	...
	INTERFACE_FUNC(EVROverlayError, ShowKeyboard, IVROverlay_016::EGamepadTextInputMode eInputMode, IVROverlay_016::EGamepadTextInputLineMode eLineInputMode, const char *pchDescription, uint32_t unCharMax, const char *pchExistingText, bool bUseMinimalMode, uint64_t uUserValue);

	INTERFACE_FUNC(EVROverlayError, ShowKeyboardForOverlay, VROverlayHandle_t ulOverlayHandle, IVROverlay_016::EGamepadTextInputMode eInputMode, IVROverlay_016::EGamepadTextInputLineMode eLineInputMode, const char *pchDescription, uint32_t unCharMax, const char *pchExistingText, bool bUseMinimalMode, uint64_t uUserValue);
	...
	* typically the size of the underlying UI in pixels (not in world space). */
	INTERFACE_FUNC(EVROverlayError, SetOverlayIntersectionMask, VROverlayHandle_t ulOverlayHandle, IVROverlay_016::VROverlayIntersectionMaskPrimitive_t *pMaskPrimitives, uint32_t unNumMaskPrimitives, uint32_t unPrimitiveSize = sizeof(IVROverlay_016::VROverlayIntersectionMaskPrimitive_t));
	...
	INTERFACE_FUNC(IVROverlay_016::VRMessageOverlayResponse, ShowMessageOverlay, const char* pchText, const char* pchCaption, const char* pchButton0Text, const char* pchButton1Text = nullptr, const char* pchButton2Text = nullptr, const char* pchButton3Text = nullptr);
};
