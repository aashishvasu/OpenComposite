...
public:
	...
	*  which is currently .png. */
	INTERFACE_FUNC(vr::IVRScreenshots_001::EVRScreenshotError, RequestScreenshot, vr::ScreenshotHandle_t *pOutScreenshotHandle, vr::EVRScreenshotType type, const char *pchPreviewFilename, const char *pchVRFilename);
	...
	*  buttons to take a screenshot. */
	INTERFACE_FUNC(vr::IVRScreenshots_001::EVRScreenshotError, HookScreenshot, const vr::EVRScreenshotType *pSupportedTypes, int numTypes);
	...
	*  the details of the screenshot request. */
	INTERFACE_FUNC(vr::EVRScreenshotType, GetScreenshotPropertyType, vr::ScreenshotHandle_t screenshotHandle, vr::IVRScreenshots_001::EVRScreenshotError *pError);

	/** Get the filename for the preview or vr image (see
	*  EScreenshotPropertyFilenames).  The return value is
	*  the size of the string.   */
	INTERFACE_FUNC(uint32_t, GetScreenshotPropertyFilename, vr::ScreenshotHandle_t screenshotHandle, vr::EVRScreenshotPropertyFilenames filenameType, VR_OUT_STRING() char *pchFilename, uint32_t cchFilename, vr::IVRScreenshots_001::EVRScreenshotError *pError);
	...
	*  bar. */
	INTERFACE_FUNC(vr::IVRScreenshots_001::EVRScreenshotError, UpdateScreenshotProgress, vr::ScreenshotHandle_t screenshotHandle, float flProgress);
	...
	*  talk to the application, just takes the shot and submits. */
	INTERFACE_FUNC(vr::IVRScreenshots_001::EVRScreenshotError, TakeStereoScreenshot, vr::ScreenshotHandle_t *pOutScreenshotHandle, const char *pchPreviewFilename, const char *pchVRFilename);
	...
	*  initiated by a user (achievement earned or something) */
	INTERFACE_FUNC(vr::IVRScreenshots_001::EVRScreenshotError, SubmitScreenshot, vr::ScreenshotHandle_t screenshotHandle, vr::EVRScreenshotType type, const char *pchSourcePreviewFilename, const char *pchSourceVRFilename);
};
