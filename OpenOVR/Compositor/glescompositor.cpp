...
void GLESCompositor::Invoke(const vr::Texture_t* texture)
{
...
void GLESCompositor::Invoke(XruEye eye, const vr::Texture_t* texture, const vr::VRTextureBounds_t* ptrBounds,
...
void GLESCompositor::InvokeCubemap(const vr::Texture_t* textures)
{
	OOVR_ABORT("GLESCompositor::InvokeCubemap: Not yet supported!");
}

void GLESCompositor::CheckCreateSwapChain(GLuint image)
{
